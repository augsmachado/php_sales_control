    ...
    <html>
        <body>
            ...
            <div class="container">
                ...
                <form class="form-group" id="individualRegister" method="post" action="sellerAction.php">
                        ...
                        <div class="row">
                            <form class="form-inline">
                                ...
                                <div class="form-group col-sm-2">
                                    <input type="text" class="form-control"  id="sellerCityInput" name="sellerCityInput" placeholder="City">
                                </div>
                                <div class="form-group col-sm-2">
