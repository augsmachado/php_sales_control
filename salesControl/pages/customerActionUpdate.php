...
<?php
    ...
    $c->editClientQuery($connection, $c->get_idClient(), $c->get_cpf(), $c->get_name(), $c->get_address(), $c->get_city(), $c->get_cep(), $c->get_uf(), $c->get_ddd(), $c->get_tel(), $c->get_creditLimit(), $c->get_availableLimit());
